...
const KurukshetraMitra = (function() {
    ...
    function initializeModules() {
        ...
        try {
            ...
            console.log(`   Device: ${state.modules.platform.platform}`);
            console.log(`   OS: ${state.modules.platform.os}`);
            console.log(`   Browser: ${state.modules.platform.browser}`);
            ...
            try {
                ...
                console.log('   Modal Controller initialized successfully');
            } catch (error) {
                console.error('   Modal Controller initialization failed:', error);
                throw error;
            }
            ...
            try {
                ...
                console.error('   Chat Mode initialization failed:', error);
                throw error;
            }
